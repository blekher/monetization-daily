...
async function addWidget() {
    ...
    widget.setAttribute('style', 'position: fixed; bottom: 20px; right: 20px; z-index: 99999999; background-color: #fff; padding: 10px; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);');
    widget.innerHTML = `
